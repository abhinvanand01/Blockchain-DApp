...
import 'package:fibble/consumerPage.dart';
                        ...
                        onPressed: () async {
                          ...
                          if (currentUser.contains('consumer') &&
                            ...
                            Navigator.pushReplacement(
                              ...
                              currentUser.contains(password) && email!='' && password!='')
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ManufacturerPage(uname: email,)));
                          else if (currentUser.contains('shipper') &&
                              currentUser.contains(password) && email!='' && password!='')
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ShipperPage(uname: email,)));
                          else
                          {
